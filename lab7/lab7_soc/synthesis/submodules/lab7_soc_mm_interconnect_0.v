...
module lab7_soc_mm_interconnect_0 (
	...
	wire          cmd_mux_007_src_valid;                                                              // cmd_mux_007:src_valid -> ac_reset_s1_agent:cp_valid
	wire  [106:0] cmd_mux_007_src_data;                                                               // cmd_mux_007:src_data -> ac_reset_s1_agent:cp_data
	wire          cmd_mux_007_src_ready;                                                              // ac_reset_s1_agent:cp_ready -> cmd_mux_007:src_ready
	wire    [8:0] cmd_mux_007_src_channel;                                                            // cmd_mux_007:src_channel -> ac_reset_s1_agent:cp_channel
	wire          cmd_mux_007_src_startofpacket;                                                      // cmd_mux_007:src_startofpacket -> ac_reset_s1_agent:cp_startofpacket
	wire          cmd_mux_007_src_endofpacket;                                                        // cmd_mux_007:src_endofpacket -> ac_reset_s1_agent:cp_endofpacket
	...
	wire          cmd_mux_008_src_valid;                                                              // cmd_mux_008:src_valid -> sum_s1_agent:cp_valid
	wire  [106:0] cmd_mux_008_src_data;                                                               // cmd_mux_008:src_data -> sum_s1_agent:cp_data
	wire          cmd_mux_008_src_ready;                                                              // sum_s1_agent:cp_ready -> cmd_mux_008:src_ready
	wire    [8:0] cmd_mux_008_src_channel;                                                            // cmd_mux_008:src_channel -> sum_s1_agent:cp_channel
	wire          cmd_mux_008_src_startofpacket;                                                      // cmd_mux_008:src_startofpacket -> sum_s1_agent:cp_startofpacket
	wire          cmd_mux_008_src_endofpacket;                                                        // cmd_mux_008:src_endofpacket -> sum_s1_agent:cp_endofpacket
	...
	wire          ac_reset_s1_agent_rp_valid;                                                         // ac_reset_s1_agent:rp_valid -> router_009:sink_valid
	wire  [106:0] ac_reset_s1_agent_rp_data;                                                          // ac_reset_s1_agent:rp_data -> router_009:sink_data
	wire          ac_reset_s1_agent_rp_ready;                                                         // router_009:sink_ready -> ac_reset_s1_agent:rp_ready
	wire          ac_reset_s1_agent_rp_startofpacket;                                                 // ac_reset_s1_agent:rp_startofpacket -> router_009:sink_startofpacket
	wire          ac_reset_s1_agent_rp_endofpacket;                                                   // ac_reset_s1_agent:rp_endofpacket -> router_009:sink_endofpacket
	...
	wire          sum_s1_agent_rp_valid;                                                              // sum_s1_agent:rp_valid -> router_010:sink_valid
	wire  [106:0] sum_s1_agent_rp_data;                                                               // sum_s1_agent:rp_data -> router_010:sink_data
	wire          sum_s1_agent_rp_ready;                                                              // router_010:sink_ready -> sum_s1_agent:rp_ready
	wire          sum_s1_agent_rp_startofpacket;                                                      // sum_s1_agent:rp_startofpacket -> router_010:sink_startofpacket
	wire          sum_s1_agent_rp_endofpacket;                                                        // sum_s1_agent:rp_endofpacket -> router_010:sink_endofpacket
	...
	wire          ac_reset_s1_agent_rdata_fifo_src_valid;                                             // ac_reset_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_007:in_0_valid
	wire   [33:0] ac_reset_s1_agent_rdata_fifo_src_data;                                              // ac_reset_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_007:in_0_data
	wire          ac_reset_s1_agent_rdata_fifo_src_ready;                                             // avalon_st_adapter_007:in_0_ready -> ac_reset_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_007_out_0_valid;                                                  // avalon_st_adapter_007:out_0_valid -> ac_reset_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_007_out_0_data;                                                   // avalon_st_adapter_007:out_0_data -> ac_reset_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_007_out_0_ready;                                                  // ac_reset_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_007:out_0_ready
	wire    [0:0] avalon_st_adapter_007_out_0_error;                                                  // avalon_st_adapter_007:out_0_error -> ac_reset_s1_agent:rdata_fifo_sink_error
	wire          sum_s1_agent_rdata_fifo_src_valid;                                                  // sum_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_008:in_0_valid
	wire   [33:0] sum_s1_agent_rdata_fifo_src_data;                                                   // sum_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_008:in_0_data
	wire          sum_s1_agent_rdata_fifo_src_ready;                                                  // avalon_st_adapter_008:in_0_ready -> sum_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_008_out_0_valid;                                                  // avalon_st_adapter_008:out_0_valid -> sum_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_008_out_0_data;                                                   // avalon_st_adapter_008:out_0_data -> sum_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_008_out_0_ready;                                                  // sum_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_008:out_0_ready
	wire    [0:0] avalon_st_adapter_008_out_0_error;                                                  // avalon_st_adapter_008:out_0_error -> sum_s1_agent:rdata_fifo_sink_error
